  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      if (answer && typeof answer === 'string') {
        ...
        console.error('Invalid answer format:', answer); // Add error logging
        setMessages((prev) => [
          ...prev,
          {
            role: "ai",
            content: "Sorry, I couldn't generate a proper response."
          }
        ]);
      }
    } catch (error) {
      console.error('Error in handleSendMessage:', error); // Add error logging
      setMessages((prev) => [
        ...prev,
        {
          role: "ai",
